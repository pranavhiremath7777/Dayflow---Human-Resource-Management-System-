...
import { applyTheme, getInitialTheme } from "@/components/layout/theme-toggle";
  ...
  head: () => ({
    meta: [
      ...
      { title: "Dayflow — Every workday, perfectly aligned" },
      {
        name: "description",
        content:
          "Dayflow is a human resource management system for attendance, leave approvals, payroll visibility and people operations.",
      },
